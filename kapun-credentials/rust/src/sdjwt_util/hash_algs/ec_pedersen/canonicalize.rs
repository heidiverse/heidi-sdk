...
pub fn canonicalize_object(v: &kapun_util_rust::value::Value) -> String {
...
pub fn stringify_value(value: &kapun_util_rust::value::Value) -> String {
    match value {
...
mod tests {
    ...
    fn test_canonicalize() {
        ...
        let val: kapun_util_rust::value::Value = v.into();
