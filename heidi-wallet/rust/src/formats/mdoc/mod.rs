...
use oid4vc::{
    dif_presentation_exchange::{self, input_evaluation::FieldQueryResult},
    oid4vp::{
        ClaimFormatDesignation, InputDescriptor, InputDescriptorMappingObject, Oid4vpParams,
...
pub fn evaluate_input_raw(
    ...
    dif_presentation_exchange::input_evaluation::evaluate_input_raw(
        &input_descriptor,
...
mod tests {
    ...
    fn test_evaluate_input_raw() {
        ...
        let value: Value = {
            ...
            let bytes = oid4vc::oid4vc_core::jwt::base64_url_decode(&issuer_signed).unwrap();
