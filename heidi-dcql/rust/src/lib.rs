...
//TODO: Fix the tests (there is the studierendenausweis missing)
// #[cfg(test)]
// mod tests {
...
//             "meta" : {
//                 "vct_values" : [
//                         "https://creator-ws.tg4u.ch/v1/schema/basis-id-5bwu5/0.0.2"
//                     ]
//             },
//             "claims" : [
//                 {
...
//             match m {
//                 crate::DcqlQueryMismatch::CredentialQueryNotFound { id } => continue,
//                 crate::DcqlQueryMismatch::UnsatisfiedCredentialQuery {
//                     query_id,
//                     credential,
//                     reason,
//                 } => {
//                     if creds[0].set_options[0][0].id == query_id {
//                         continue;
//                     }
//                     match credential {
